...
const index = () => {
  return (
    <section
      id="location"
      className="relative w-full flex items-center justify-center text-justify p-10 gap-4 h-[100vh] shadow-md bg-[#f0fdfa]"
    >
      <div className="relative w-full max-w-4xl">
        ...
        <div className="flex flex-col justify-center items-center italic">
          <div className="grid grid-cols-2 gap-2 items-center">
            <div className="col-span-1 bg-emerald-50 border-4 border-emerald-200 rounded-lg shadow-lg overflow-hidden flex flex-col h-full">
              <div className="relative w-full h-48">
                <img
                  src={JasmineBeachResort}
                  alt="Jasmine Beach Resort"
                  className="w-full h-full object-cover shadow"
                />
              </div>

              <div className="p-2 flex-grow bg-white">
                <p className="text-sm text-green-700 leading-relaxed mb-2 flex items-center gap-1">
                  <MapPin className="w-4 h-4 text-emerald-500" />
                  <strong>Venue:</strong> Jasmine Beach Resort
                </p>

                <p className="text-sm text-green-700 leading-relaxed mb-2 flex items-center gap-1 whitespace-normal break-words">
                  <MapIcon className="w-4 h-4 text-emerald-500" />
                  <strong>Address:</strong> Brgy. Amambucale, Marabut Samar
                </p>

                <p className="text-sm text-green-700 leading-relaxed mb-2 flex items-center gap-2">
                ...
                <hr className="my-4 border-emerald-400" />
