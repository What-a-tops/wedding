  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-2 items-center w-full max-w-4xl h-full">
        <div className="col-span-1 overflow-hidden flex flex-col h-full flex-1 border-2 rounded-lg border-lime-600">
          <Form />
        </div>

        <div className="col-span-1 h-full flex flex-col gap-2 flex-1">
          <div className="flex-1 flex flex-col items-center border-2 border-lime-600 p-6 rounded-lg shadow-md w-full h-full">
            <h2 className="text-lg font-bold text-lime-700 tracking-wider mb-2">
              ATTIRE: <span className="text-lime-900">SMART CASUAL</span>
            </h2>
          ...
          <div className="flex-1 flex flex-col items-center border-2 border-lime-600 p-6 rounded-lg shadow-md w-full h-full">
            <h5 className="text-lg font-bold text-lime-700 tracking-wider mb-2">
              RECOMMENDED COLORS:
            </h5>
